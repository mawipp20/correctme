	...
	return this.each(function() {
		...
		var sendContentToMirror = function (textarea) {
			...
			if (jQuery(textarea).height() != jQuery(mirror).height())
                var this_new_height = parseInt(jQuery(mirror).height());
                if(typeof(textarea_autogrow_reduce_height_by)!="undefined"){
                    this_new_height -= (textarea_autogrow_reduce_height_by + 4);
                }
				jQuery(textarea).height(this_new_height);

...
<div class="Lesson">
    ...
    <?php $form = ActiveForm::begin([
          ...
          <?= $form->field($teacher, 'studentkey'
            ...
            ->label(Yii::$app->_L->get('student_join_'.Yii::$app->params["cmPollOrLesson"].'_student_label'))
            ; ?>

        <div class="form-group" style="margin-top: 1em;">
            <?= Html::submitButton(Yii::$app->_L->get('student_join_'.Yii::$app->params["cmPollOrLesson"].'_btn_submit'), ['class' => 'btn btn-primary', 'id'=>'student_join_btn_submit']) ?>
        </div>
    <?php ActiveForm::end(); ?>
